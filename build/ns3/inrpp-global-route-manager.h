...
#ifndef INRPP_GLOBAL_ROUTE_MANAGER_H
#define INRPP_GLOBAL_ROUTE_MANAGER_H
 ...
 */
  InrppGlobalRouteManager (InrppGlobalRouteManager& srm);
 ...
 */
  InrppGlobalRouteManager& operator= (InrppGlobalRouteManager& srm);
};
