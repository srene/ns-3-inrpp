 ...
 */
#ifndef INRPP_GLOBAL_ROUTING_HELPER_H
#define INRPP_GLOBAL_ROUTING_HELPER_H
 ...
 */
class InrppGlobalRoutingHelper : public Ipv4RoutingHelper  
{
public:
   ...
   *
  */
  InrppGlobalRoutingHelper (const InrppGlobalRoutingHelper &);
...
private:
   ...
   * \return
   */
  InrppGlobalRoutingHelper &operator = (const InrppGlobalRoutingHelper &);
};
