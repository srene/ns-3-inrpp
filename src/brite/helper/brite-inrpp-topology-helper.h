...
#ifndef BRITE_INRPP_TOPOLOGY_HELPER_H
#define BRITE_INRPP_TOPOLOGY_HELPER_H
...
class BriteInrppTopologyHelper
{
public:
  /**
   * Construct a BriteInrppTopologyHelper
   *
   ...
   */
  BriteInrppTopologyHelper (std::string confFile,
                       std::string seedFile,
                       std::string newseedFile);

  /**
   * Construct a BriteInrppTopologyHelper using NS3 to generate seed values
   * need by BRITE
   *
   */
  BriteInrppTopologyHelper (std::string confFile);

  ~BriteInrppTopologyHelper ();
   ...
   */
  void BuildBriteTopology (InrppStackHelper& stack);
   ...
   *
   */
  void BuildBriteTopology (InrppStackHelper& stack, const uint32_t systemCount);
...
#endif /* BRITE_INRPP_TOPOLOGY_HELPER_H */
